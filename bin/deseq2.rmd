...
total_sig_degs <- nrow(subset(res.df, padj < 0.01 & abs(log2FoldChange) > 2))
```

**`r total_sig_degs`** DEGs were identified with adjusted p-value < 0.01 and absolute log2FoldChange > 2.
